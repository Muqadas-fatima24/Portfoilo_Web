                ...
                <div class="container container-1620 clearfix">
                    ...
                    <div class="header-inner rel d-flex align-items-center">
                        <div class="logo-outer">
                            <div class="logo"><a href="index.html"><img src="assets/logo.webp" alt="Logo"
                                        title="Logo"></a></div>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-sm-7">
                        ...
                        <div class="hero-content rmb-55 fadeInUp1">
                            ...
                            <div class="hero-btns">
                                <a href="contact.html" class="theme-btn">Hire Me <i class="fas fa-angle-right"></i></a>
                                <a href="contact.html" class="read-more">Download Resume <i class="fas fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-5 order-lg-3">
                        <div class="hero-counter-wrap ms-lg-auto rmb-55 fadeInUp2" style="visibility: visible;">
                    ...
                    <div class="col-lg-5">
                        <div class="author-image-part wow fadeIn delay-0-3s" style="visibility: visible;">
                            <div class="bg-circle"></div>
                            <img src="assets/me.webp" alt="Author">
                    ...
                    <div class="row gap-100 align-items-center">
                        <div class="col-lg-7">
                            <div class="about-content-part rel z-2 rmb-55">
                                <div class="section-title mb-35 box" style="visibility: visible;">
                                ...
                                <ul class="list-style-one two-column box" style="visibility: visible;">
                                    <li>Branding &amp; Design</li>
                                    <li>Digital Marketing</li>
                                    <li>Web Development</li>
                                    <li>Product Design</li>
                                </ul>
                                <div class="about-info-box mt-25 box" style="visibility: visible;">
                        ...
                        <div class="col-lg-5">
                            <div class="about-image-part box" style="visibility: visible; animation-delay:.3s;">
 ...
 <div class="client-logo-area rel z-1 pt-130 rpt-100 pb-60">
            <div class="container">
                ...
                <div class="client-logo-wrap">
                    ...
                    <a class="client-logo-itembox" href="contact.html" style="visibility: visible; animation-delay: .3s">
